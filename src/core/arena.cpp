...
Arena::Arena(size_t capacity) : capacity_(capacity), offset_(0) { ptr_ = capacity > 0 ? new char[capacity] : nullptr; }

Arena::~Arena() { delete[] ptr_; }
